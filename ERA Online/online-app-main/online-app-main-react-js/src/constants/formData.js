...
export const electoralDistrictLevelList = [
  "House of representative in national level",
  "Senate",
  "House of representative in provincial level",
  "House of representative in municipal level",
];
